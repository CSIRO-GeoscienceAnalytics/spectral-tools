...
#define __PYX_HAVE__chulls
#define __PYX_HAVE_API__chulls
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'chulls' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static int __pyx_v_6chulls_NUM_THREADS;
...
static void __pyx_f_6chulls_extract_subhull(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int); /*proto*/
static void __pyx_f_6chulls_extract_hull_0d(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
static void __pyx_f_6chulls_extract_hull_1d(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
static void __pyx_f_6chulls_extract_hull_2d(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
...
#define __Pyx_MODULE_NAME "chulls"
extern int __pyx_module_is_main_chulls;
...
static const char __pyx_k_hull_type[] = "hull_type";
static const char __pyx_k_pyx_state[] = "__pyx_state";
static const char __pyx_k_reduce_ex[] = "__reduce_ex__";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_absorption[] = "absorption";
static const char __pyx_k_chulls_pyx[] = "chulls.pyx";
...
static const char __pyx_k_get_absorption[] = "get_absorption";
...
static const char __pyx_k_Extraction_not_available_for_ras[] = "Extraction not available for raster dimension >= 3";
...
static PyObject *__pyx_kp_u_Extraction_not_available_for_ras;
...
static PyObject *__pyx_kp_s_chulls_pyx;
...
static PyObject *__pyx_n_s_get_absorption;
static PyObject *__pyx_n_s_getstate;
static PyObject *__pyx_kp_s_got_differing_extents_in_dimensi;
static PyObject *__pyx_n_s_hull_type;
...
static PyObject *__pyx_pf_6chulls_get_absorption(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_wavelengths, PyObject *__pyx_v_spectra, PyObject *__pyx_v_hull_type); /* proto */
...
static void __pyx_f_6chulls_extract_subhull(__Pyx_memviewslice __pyx_v_spectrum, __Pyx_memviewslice __pyx_v_absorption, __Pyx_memviewslice __pyx_v_wavelengths, int __pyx_v_start, int __pyx_v_end, int __pyx_v_hull_type) {
  int __pyx_v_iidx;
  int __pyx_v_minidx;
  double __pyx_v_minabsorb;
  double __pyx_v_hull;
  double __pyx_v_m;
 ...
 */
  ...
  if (__pyx_t_1 < 0) __pyx_t_1 += __pyx_v_spectrum.shape[0];
 ...
 */
  ...
  if (__pyx_t_3 < 0) __pyx_t_3 += __pyx_v_wavelengths.shape[0];
 ...
 */
      if (((__pyx_v_hull == 0.0) != 0)) {
        __pyx_t_8 = 0.0;
      } else {
        __pyx_t_2 = __pyx_v_iidx;
        if (__pyx_t_2 < 0) __pyx_t_2 += __pyx_v_spectrum.shape[0];
        __pyx_t_8 = (1.0 - ((*((double *) ( /* dim=0 */ (__pyx_v_spectrum.data + __pyx_t_2 * __pyx_v_spectrum.strides[0]) ))) / __pyx_v_hull));
      }
      __pyx_t_2 = __pyx_v_iidx;
 ...
 */
      if (((__pyx_v_hull == 0.0) != 0)) {
        ...
        __pyx_t_2 = __pyx_v_iidx;
        if (__pyx_t_2 < 0) __pyx_t_2 += __pyx_v_spectrum.shape[0];
        __pyx_t_8 = (__pyx_v_hull - (*((double *) ( /* dim=0 */ (__pyx_v_spectrum.data + __pyx_t_2 * __pyx_v_spectrum.strides[0]) ))));
      }
      __pyx_t_2 = __pyx_v_iidx;
      if (__pyx_t_2 < 0) __pyx_t_2 += __pyx_v_absorption.shape[0];
      *((double *) ( /* dim=0 */ (__pyx_v_absorption.data + __pyx_t_2 * __pyx_v_absorption.strides[0]) )) = __pyx_t_8;
 ...
 *         else:
 */
    __pyx_t_10 = (((__pyx_v_minidx - __pyx_v_start) > 0) != 0);
    if (__pyx_t_10) {
    } else {
      __pyx_t_9 = __pyx_t_10;
      goto __pyx_L10_bool_binop_done;
    }
    __pyx_t_10 = ((__pyx_v_minidx != __pyx_v_end) != 0);
    __pyx_t_9 = __pyx_t_10;
 ...
 */
      /*else*/ {
        __pyx_t_2 = __pyx_v_minidx;
        if (__pyx_t_2 < 0) __pyx_t_2 += __pyx_v_absorption.shape[0];
        *((double *) ( /* dim=0 */ (__pyx_v_absorption.data + __pyx_t_2 * __pyx_v_absorption.strides[0]) )) = 0.0;
      }
      __pyx_L12:;
    }
    __pyx_L9:;
 ...
 *         else:
 */
    __pyx_t_10 = (((__pyx_v_end - __pyx_v_minidx) > 0) != 0);
    if (__pyx_t_10) {
    } else {
      __pyx_t_9 = __pyx_t_10;
      goto __pyx_L14_bool_binop_done;
    }
    __pyx_t_10 = ((__pyx_v_minidx != __pyx_v_start) != 0);
    __pyx_t_9 = __pyx_t_10;
...
static void __pyx_f_6chulls_extract_hull_1d(__Pyx_memviewslice __pyx_v_spectrum, __Pyx_memviewslice __pyx_v_absorption, __Pyx_memviewslice __pyx_v_wavelengths, int __pyx_v_hull_type) {
  int __pyx_v_iidx;
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_1, __pyx_t_2, __pyx_t_3) firstprivate(__pyx_t_4, __pyx_t_5) num_threads(__pyx_v_6chulls_NUM_THREADS)
            #endif /* _OPENMP */
            {
 ...
 */
                ...
                if ((1 == 0)) abort();
                {
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for firstprivate(__pyx_v_iidx) lastprivate(__pyx_v_iidx) schedule(dynamic)
                        #endif /* _OPENMP */
 ...
 * @cython.boundscheck(False)
 */
                                __pyx_t_4.data = __pyx_v_spectrum.data;
                                __pyx_t_4.memview = __pyx_v_spectrum.memview;
                                __PYX_INC_MEMVIEW(&__pyx_t_4, 0);
                                {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_iidx;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_spectrum.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_spectrum.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_4.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_4.shape[0] = __pyx_v_spectrum.shape[1];
__pyx_t_4.strides[0] = __pyx_v_spectrum.strides[1];
    __pyx_t_4.suboffsets[0] = -1;

__pyx_t_5.data = __pyx_v_absorption.data;
                                __pyx_t_5.memview = __pyx_v_absorption.memview;
                                __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
                                {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_iidx;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_absorption.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_absorption.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_5.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_5.shape[0] = __pyx_v_absorption.shape[1];
__pyx_t_5.strides[0] = __pyx_v_absorption.strides[1];
    __pyx_t_5.suboffsets[0] = -1;

__pyx_f_6chulls_extract_subhull(__pyx_t_4, __pyx_t_5, __pyx_v_wavelengths, 0, __pyx_v_nwvl, __pyx_v_hull_type);
...
static void __pyx_f_6chulls_extract_hull_2d(__Pyx_memviewslice __pyx_v_spectrum, __Pyx_memviewslice __pyx_v_absorption, __Pyx_memviewslice __pyx_v_wavelengths, int __pyx_v_hull_type) {
  int __pyx_v_iidx;
  int __pyx_v_jidx;
  CYTHON_UNUSED int __pyx_v_nx;
  int __pyx_v_ny;
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6) firstprivate(__pyx_t_7, __pyx_t_8) num_threads(__pyx_v_6chulls_NUM_THREADS)
            #endif /* _OPENMP */
            {
 ...
 */
                ...
                if ((1 == 0)) abort();
                {
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for firstprivate(__pyx_v_iidx) lastprivate(__pyx_v_iidx) lastprivate(__pyx_v_jidx) schedule(dynamic)
                        #endif /* _OPENMP */
                        for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                            {
                                __pyx_v_iidx = (int)(0 + 1 * __pyx_t_2);
 ...
 * 
 */
                                  __pyx_t_7.data = __pyx_v_spectrum.data;
                                  __pyx_t_7.memview = __pyx_v_spectrum.memview;
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_jidx;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_spectrum.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_spectrum.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_7.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_7.shape[0] = __pyx_v_spectrum.shape[2];
__pyx_t_7.strides[0] = __pyx_v_spectrum.strides[2];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_8.data = __pyx_v_absorption.data;
                                  __pyx_t_8.memview = __pyx_v_absorption.memview;
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_jidx;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_absorption.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_absorption.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_8.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_8.shape[0] = __pyx_v_absorption.shape[2];
__pyx_t_8.strides[0] = __pyx_v_absorption.strides[2];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_f_6chulls_extract_subhull(__pyx_t_7, __pyx_t_8, __pyx_v_wavelengths, 0, __pyx_v_nwvl, __pyx_v_hull_type);
...
static PyObject *__pyx_pw_6chulls_1get_absorption(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_spectra)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_absorption", 1, 3, 3, 1); __PYX_ERR(0, 97, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_hull_type)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_absorption", 1, 3, 3, 2); __PYX_ERR(0, 97, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_absorption") < 0)) __PYX_ERR(0, 97, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("get_absorption", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 97, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_spectra, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 119, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 119, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_wavelengths, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_2);
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_empty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_spectra, __pyx_n_s_shape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_shape, __pyx_t_3) < 0) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *     elif hull_type == 1:
 */
  __pyx_t_3 = __Pyx_PyInt_EqObjC(__pyx_v_hull_type, __pyx_int_0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 126, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 *     else:
 */
  __pyx_t_3 = __Pyx_PyInt_EqObjC(__pyx_v_hull_type, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_spectra, __pyx_n_s_ndim); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_EqObjC(__pyx_t_3, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *     elif (spectra.ndim == 2):
 */
    __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_spectra, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 135, __pyx_L1_error)
    __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_absorption, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 135, __pyx_L1_error)
    __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_wavelengths, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 135, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_v_hull_type); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 135, __pyx_L1_error)
    __pyx_f_6chulls_extract_hull_0d(__pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_spectra, __pyx_n_s_ndim); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 137, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_EqObjC(__pyx_t_2, __pyx_int_2, 2, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 137, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     elif (spectra.ndim == 3):
 */
    __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_spectra, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 138, __pyx_L1_error)
    __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_absorption, PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 138, __pyx_L1_error)
    __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_wavelengths, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 138, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_v_hull_type); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 138, __pyx_L1_error)
    __pyx_f_6chulls_extract_hull_1d(__pyx_t_10, __pyx_t_11, __pyx_t_8, __pyx_t_9);
 ...
 *     else:
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_spectra, __pyx_n_s_ndim); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 140, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_EqObjC(__pyx_t_3, __pyx_int_3, 3, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 140, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_v_spectra, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 141, __pyx_L1_error)
    __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_v_absorption, PyBUF_WRITABLE); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 141, __pyx_L1_error)
    __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_wavelengths, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 141, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_v_hull_type); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 141, __pyx_L1_error)
    __pyx_f_6chulls_extract_hull_2d(__pyx_t_12, __pyx_t_13, __pyx_t_8, __pyx_t_9);
 ...
 */
  /*else*/ {
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_NotImplementedError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "chulls._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_chulls(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_chulls},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Extraction_not_available_for_ras, __pyx_k_Extraction_not_available_for_ras, sizeof(__pyx_k_Extraction_not_available_for_ras), 0, 1, 0, 0},
  ...
  {&__pyx_kp_s_chulls_pyx, __pyx_k_chulls_pyx, sizeof(__pyx_k_chulls_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_get_absorption, __pyx_k_get_absorption, sizeof(__pyx_k_get_absorption), 0, 0, 1, 1},
  {&__pyx_n_s_getstate, __pyx_k_getstate, sizeof(__pyx_k_getstate), 0, 0, 1, 1},
  {&__pyx_kp_s_got_differing_extents_in_dimensi, __pyx_k_got_differing_extents_in_dimensi, sizeof(__pyx_k_got_differing_extents_in_dimensi), 0, 0, 1, 0},
  {&__pyx_n_s_hull_type, __pyx_k_hull_type, sizeof(__pyx_k_hull_type), 0, 0, 1, 1},
 ...
 *     return absorption
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Extraction_not_available_for_ras); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 143, __pyx_L1_error)
 ...
 *     Modified: Andrew Rodger, CSIRO Mineral Resources (15/02/2020)
 */
  __pyx_tuple__21 = PyTuple_Pack(4, __pyx_n_s_wavelengths, __pyx_n_s_spectra, __pyx_n_s_hull_type, __pyx_n_s_absorption); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 97, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initchulls(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initchulls(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_chulls(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_chulls(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_chulls(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'chulls' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_chulls(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("chulls", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_chulls) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "chulls")) {
      if (unlikely(PyDict_SetItemString(modules, "chulls", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_double); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_double, __pyx_t_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_cpu_count); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cpu_count, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * # CYTHON CODE
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_cpu_count); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     Modified: Andrew Rodger, CSIRO Mineral Resources (15/02/2020)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6chulls_1get_absorption, NULL, __pyx_n_s_chulls); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_absorption, __pyx_t_1) < 0) __PYX_ERR(0, 97, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init chulls", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init chulls");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
